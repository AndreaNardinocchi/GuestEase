      ...
      <tr>
        <td style="padding:26px; color:#472d30; font-size:15px; line-height:1.6;">
          ...
          <div style="text-align:center; margin:28px 0;">
            <a href="${frontendUrl}/account/mytrips"
...
export function bookingUpdatedByAdminTemplate({
  profile,
  roomData,
  guests,
  check_in,
    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
      ...
      <tr>
        <td style="padding:26px; color:#472d30; font-size:15px; line-height:1.6;">
          ...
          <p>Your booking has been updated by a GuestEase administrator.  
          Below you’ll find the latest details of your stay.</p>

          <!-- Room Details -->
          <div style="background:#fff3ef; border-left:4px solid #E26D5C; padding:16px; margin:20px 0; border-radius:6px;">
            <p><strong>Room:</strong> ${roomData.name}</p>
            ${roomData.capacity ? `<p><strong>Capacity:</strong> ${roomData.capacity} guests</p>` : ""}
            <p><strong>Guests:</strong> ${guests}</p>
            <p><strong>Check-in:</strong> ${check_in}</p>
            <p><strong>Check-out:</strong> ${check_out}</p>
            <p><strong>Total Nights:</strong> ${total_nights}</p>
          ...
          <p>If you have any questions or need further adjustments, our team is always here to help 🤝</p>
